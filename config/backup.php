...
return [
    'backup' => [
         ...
         * the backups.
         */
        'name' => '', // Para que los backups se guarden directo en storage/app/backups
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    base_path('storage/app/public'), // uploads/evidencias/PDFs
                    base_path('.env'),               // configuración
                ],
                ...
                'exclude' => [
                    ...
                    storage_path('app/backups'),    // no te respaldes a ti mismo
                ],
                'relative_path' => '', // requerido por Spatie >= 8
             ...
             */
            'databases' => ['mysql'], // 👈 tu conexión principal
        ],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'uppercontrol_',

            /*
             * The disk names on which the backups will be stored.
             */
            'disks' => ['backups'], // 👈 usa el disco de arriba
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => 20480, // 20 GB
        ],
    ],
];
