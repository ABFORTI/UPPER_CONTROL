      ...
      <div class="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl shadow-xl p-8 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <a :href="route('admin.centros.create')" 
             class="inline-flex items-center gap-2 px-6 py-3 bg-white text-indigo-600 font-bold rounded-xl hover:bg-indigo-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
          ...
          <table class="w-full">
            <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
              <tr>
                ...
                <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Prefijo</th>
            ...
            <tbody class="divide-y divide-gray-100">
              <tr v-for="c in data.data" :key="c.id" class="hover:bg-indigo-50 transition-colors duration-150">
                ...
                <td class="px-6 py-4 text-gray-600 text-sm">{{ c.direccion || '—' }}</td>
                <td class="px-6 py-4 text-center">
                  <span v-if="c.activo" class="inline-flex items-center gap-1 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-sm font-semibold">
                ...
                <td class="px-6 py-4">
                  <div class="flex items-center justify-end gap-2">
                    <a :href="route('admin.centros.edit', c.id)" 
                       class="inline-flex items-center gap-1 px-4 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors duration-200">
