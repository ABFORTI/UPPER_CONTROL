...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4 border-2 border-white border-opacity-30 flex flex-col sm:flex-row sm:items-center gap-4 w-full md:w-auto">
              ...
              <button v-if="can?.create" @click="openCreateModal"
                      class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto">
            ...
            <div class="md:hidden p-4 space-y-4">
              <div v-for="item in itemsList" :key="`m-${item.id}`" class="border border-gray-200 rounded-2xl p-4 shadow-sm bg-white">
                <div class="flex flex-col gap-2">
                  <div>
                    <div class="text-xs uppercase tracking-wide text-gray-500">Centro de costo</div>
