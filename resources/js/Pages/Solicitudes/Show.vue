                  ...
                  <div class="space-y-2">
                    <div v-for="(ss, idx) in servicios" :key="ss.id" 
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          <p class="font-bold text-gray-800 dark:text-slate-100">
                            <template v-if="ss.servicio">{{ ss.servicio.nombre }}</template>
                            <span v-else class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold bg-amber-100 text-amber-800 border border-amber-200">
            ...
            <div v-else-if="cotizacion?.mode === 'pendiente_tamanos'" class="p-5 space-y-4">
              <div class="px-4 py-3 rounded-xl bg-blue-50 dark:bg-blue-500/20 border-2 border-blue-200 dark:border-blue-500/40 text-blue-800 dark:text-blue-100">
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    <div class="font-semibold">Pendiente desglose por tamaños</div>
                    <p class="text-sm mt-0.5">El precio final se calculará al terminar la OT cuando se capture el desglose por tamaños.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="border-t-2 border-upper-50 pt-4 space-y-3">
                ...
                <div class="rounded-xl px-4 py-3 flex justify-between items-center bg-[#FF7A00]">
                  <span class="text-white font-bold text-lg">Total:</span>
                  <span class="text-white font-bold text-2xl">$0.00</span>
                </div>
              </div>
            </div>
          </div>
