    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
          <div class="p-3 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl shadow-lg shadow-blue-500/30">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
            </svg>
          </div>
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Nueva Solicitud de Servicio</h1>
            <p class="text-gray-600 text-sm mt-1">Complete el formulario para crear su solicitud</p>
          </div>
        </div>
      </div>
              ...
              <div class="grid md:grid-cols-2 gap-5">
                ...
                <div class="form-group">
                  ...
                  <input 
                    ...
                    class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all outline-none bg-gray-50 hover:bg-white" 
                    placeholder="Ej. Monitores Dell 24 pulgadas"
                  />
              ...
              <div v-else>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200">
                    <label class="text-xs font-bold text-purple-700 uppercase mb-2 block">Chico</label>
                    <input 
                      type="number" 
                      min="0" 
                      v-model.number="form.tamanos.chico" 
                      class="w-full px-3 py-2 text-lg font-semibold rounded-lg border-2 border-purple-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-100 transition-all outline-none bg-white"
                    />
                    <div v-if="preciosServicio" class="text-xs text-purple-600 mt-2 font-semibold">$ {{ puTam.chico.toFixed(2) }}</div>
                  </div>
                ...
                <!-- Total de Piezas -->
                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 border-2 border-indigo-200 mb-4">
            ...
            <div class="p-6 space-y-5">
              ...
              <div class="form-group">
                ...
                <div class="relative">
                  <input 
                    ...
                    class="w-full px-4 py-3 rounded-xl border-2 border-dashed border-gray-300 hover:border-purple-400 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all outline-none bg-gray-50 hover:bg-purple-50 text-sm
                    file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r file:from-purple-600 file:to-pink-600 file:text-white hover:file:from-purple-700 hover:file:to-pink-700 file:cursor-pointer file:transition-all"
                  />
                </div>
                ...
                <div v-if="form.archivos.length" class="mt-4 space-y-2">
                  <div v-for="(file, i) in form.archivos" :key="i" class="flex items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl">
              ...
              <div class="form-group">
                ...
                <textarea 
                  v-model="form.notas" 
                  rows="4" 
                  class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all outline-none bg-gray-50 hover:bg-white resize-none" 
        ...
        <aside class="lg:col-span-1">
          <div class="sticky top-8 space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              <div class="bg-gradient-to-br from-gray-800 to-gray-900 px-5 py-4">
              ...
              <div class="p-5 space-y-4">
                ...
                <div class="pb-3 border-b border-gray-200">
                  ...
                  <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold"
                    :class="usaTamanos ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'"
                  >
                ...
                <div v-else class="pb-3 border-b border-gray-200">
                  ...
                  <div class="grid grid-cols-2 gap-2 text-xs">
                    <div class="flex items-center justify-between p-2 bg-purple-50 rounded-lg">
                      <span class="text-purple-600 font-medium">Chico</span>
                      <span class="font-bold text-purple-900">{{ form.tamanos.chico || 0 }}</span>
                    </div>
